...
# usage
# python3 split01_obj.py <num of columns>
...
def main():
    ...
    #df.to_csv('./01_EditDocument_1.csv',sep=',', index=False, header=True)
    df.to_csv('./02_DocViewer_1.csv',sep=',', index=False, header=True)
    df.to_csv('./09_PartnerConnect_1.csv',sep=',', index=False, header=True)
    print("-------------------------------------")
